...
// Lista de Comisiones
const listaComision = [
"APERTURA CTA CTE","AVANCE CMR","COM.EFECTIVAS","COMI. KIOSCO OTRAS EMPRESAS",
"COMISION CONNECT","COMISION CYD","COMISION DIGITA Y GANA","COMISIÓN SEGURO DE VIDA",
"COMPENSACION PERMISO","CONCURSO FPAY","DIF COMISION DIGITA Y GANA","DIF CONCURSO FPAY",
"DIF. COMISIONES","DIF. ESCANEA Y PAGA","DIF. INCENTI PRODUCT CAJAS","ESCANEA Y PAGA",
"INCENTIVO PRODUC CAJAS AUT","INCENTIVO SELF CHECK OUT AUT","PROMOCIONES CMR"

];

const listaGratificables = [
"APERTURA CTA CTE", "AVANCE CMR", "BONO ASISTENCIA", "BONO ASISTENCIA AUT.", "BONO CERTIFICACION", "BONO CLICK AND COLLECT", 
"BONO CUMPLIMIENTO DE ", "BONO CYBER", "BONO DICIEMBRE", "BONO INVENTARIO", "BONO PUNTUALIDAD AUT.", "BONO VACACIONES", 
"COMISIÓN SEGURO DE VIDA", "COMISION VACACIONES", "COMPENSACION PERMISO", "DIF BONO CUMPLIMIENTO DE HP.", "DIF COMISION DIGITA Y GANA", "DIF PREMIO CLICK AND COLLECT", 
"DIF PREMIO VENTA TIENDA", "DIF. CONTING. MES ANTERIOR", "DIF. SB MES ANTERIOR", "DIF. SUELDO BASE", "DIF.HORAS EXTRAS ", "DIF.SUELDO BASE CONTINGENCIA", 
"DIFERENCIA 70%", "DIFERENCIA CONTINGENCIA", "DIFERENCIA SEMANA CORRIDA", "GARANTIZADO", "HORAS RECARGO NAVIDAD", "HORAS TRABAJO SIND.", 
"INCENTIVO CONFIABILIDAD", "INCENTIVO PRODUC CAJAS AUT", "INCENTIVO RECUPERO", "INCENTIVO SELF CHECK OUT", "INCENTIVO TIENDA CD/SFS", "PREMIO CLICK AND COLLECT", 
"PREMIO CUMPL.GRUPAL NPS", "PREMIO CUMPL.GRUPAL VTAS", "PREMIO CUMPLIMIENTO DE PLAN", "PREMIO NPS", "PREMIO VENTA TIENDA", "PREMIO VENTA TIENDA AUT.", 
"PROMEDIOS VARIOS", "PROMOCIONES CMR", "QUIEBRE DE STOCK", "QUINQUENIO"
];
